...
def generate_launch_description():
    ...
    sim_headless = LaunchConfiguration('sim_headless', default='false')
    ...
    world_file = os.path.join(pkg_nav_map, 'worlds', 'narrow_path.sdf')

    ld.add_action(DeclareLaunchArgument(
        'sim_headless',
        default_value='false',
        description='Run Gazebo with the GUI enabled when true.'))
